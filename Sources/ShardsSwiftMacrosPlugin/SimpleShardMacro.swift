...
public struct SimpleShardMacro: MemberMacro, ExtensionMacro {
    ...
    public static func expansion(
        ...
        members.append(generateCommonBody())
    ...
    private static func generateCommonBody() -> DeclSyntax {
        return """
    ...
    private static func generateCBridgeBoilerplate(className: String) -> [DeclSyntax] {
        return [
            ...
            "static var inputTypesCFunc: SHInputTypesProc { { bridgeInputTypes(\(raw: className).self, shard: $0) } }",
            "static var outputTypesCFunc: SHInputTypesProc { { bridgeOutputTypes(\(raw: className).self, shard: $0) } }",
            "static var destroyCFunc: SHDestroyProc { { bridgeDestroy(\(raw: className).self, shard: $0) } }",
            "static var nameCFunc: SHNameProc { { _ in bridgeName(\(raw: className).self) } }",
            "static var hashCFunc: SHHashProc { { _ in bridgeHash(\(raw: className).self) } }",
            "static var helpCFunc: SHHelpProc { { _ in bridgeHelp(\(raw: className).self) } }",
            "static var parametersCFunc: SHParametersProc { { bridgeParameters(\(raw: className).self, shard: $0) } }",
            "static var setParamCFunc: SHSetParamProc { { bridgeSetParam(\(raw: className).self, shard: $0, idx: $1, input: $2) } }",
            "static var getParamCFunc: SHGetParamProc { { bridgeGetParam(\(raw: className).self, shard: $0, idx: $1) } }",
            "static var exposedVariablesCFunc: SHExposedVariablesProc { { bridgeExposedVariables(\(raw: className).self, shard: $0) } }",
            "static var requiredVariablesCFunc: SHRequiredVariablesProc { { bridgeRequiredVariables(\(raw: className).self, shard: $0) } }",
            "static var composeCFunc: SHComposeProc { { bridgeCompose(\(raw: className).self, shard: $0, data: $1) } }",
            "static var warmupCFunc: SHWarmupProc { { bridgeWarmup(\(raw: className).self, shard: $0, ctx: $1) } }",
            "static var cleanupCFunc: SHCleanupProc { { bridgeCleanup(\(raw: className).self, shard: $0, ctx: $1) } }",
            "static var activateCFunc: SHActivateProc { { bridgeActivate(\(raw: className).self, shard: $0, ctx: $1, input: $2) } }",
